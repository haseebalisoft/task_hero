...
class AddProfileDetailsView extends StatelessWidget with Validators{
   AddProfileDetailsView({super.key});
            ...
            children: [
              ...
              InkWell(
                onTap: ()=>Get.to(()=>SetLocationView()),
                  child: CustomTextField(title: 'Location',hintText: 'Location',suffixIcon: Assets.icons.location,enabled: false,validator: (_)=>null,)),
              20.h,
              InkWell(
              ...
              40.h,
              Center(child: AppButton.primary(title: 'Save & continue',onPressed: (){
